...
if errstr == "":
	...
	if (cursor):
		...
		if len(wpID) > 0:
			...
			setCriteria += ' AND tWaypoint.planetID=(SELECT planetID FROM tPlanet WHERE LOWER(REPLACE(planetName," ","")) = "' + planet + '")'
		else:
